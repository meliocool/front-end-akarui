    ...
    <div className="flex w-full flex-col items-center justify-center gap-10 lg:flex-row lg:gap-20">
      ...
      <Card>
        <CardBody className="p-8">
          ...
          {errors.root && (
            <p className="mb-2 text-small text-danger">
              {errors?.root?.message}
            </p>
          )}
          <form
              ...
              render={({ field }) => (
                <Input
                  ...
                  endContent={
                    ...
                    >
                      {isVisible ? (
                        <FaEye className="pointer-events-none mb-2 text-xl text-default-400" />
                      ) : (
                        <FaEyeSlash className="pointer-events-none mb-2 text-xl text-default-400" />
                      )}
                    </button>
                  }
                />
